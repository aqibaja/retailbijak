      ...
      <section class="grid grid-cols-12 stagger-reveal">
        ...
        <div class="col-span-8 panel flex-col gap-6">
            ...
            <div class="flex-col gap-4">
                <div class="flex gap-4 p-5" style="background:var(--bg-elevated); border:1px solid var(--border-subtle); border-radius:12px; transition:transform 0.2s;">
        ...
        <div class="col-span-4 panel flex-col justify-center items-center text-center" style="background:linear-gradient(135deg, var(--bg-elevated), rgba(99,102,241,0.04)); min-height:300px; border-color:rgba(99,102,241,0.18);">
