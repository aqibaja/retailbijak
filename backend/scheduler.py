...
def init_scheduler():
    ...
    scheduler.add_job(generate_and_store_daily_ai_pick_report, trigger=CronTrigger(day_of_week='mon-fri', hour=8, minute=0, timezone=jkt_tz), id="daily_ai_picks", replace_existing=True)
